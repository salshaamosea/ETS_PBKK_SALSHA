  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-12">
          <div class="col">
            <center><h1 class="m-0 text-dark">Kategori Barang</h1></center>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            <table class="table w-100 table-striped table-sm" id="kategori_produk">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Kategori</th>
          ...
          <div class="card-header">
            <button class="btn btn-info" data-toggle="modal" data-target="#modal" onclick="add()" style="float:right;">Tambahkan Kategori Barang</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
