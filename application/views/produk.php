  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <center><h1 class="m-0 text-dark">Produk</h1></center>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            <table class="table w-100 table-striped table-sm" id="produk">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Kode Produk</th>
          ...
          <div class="card-header">
            <button class="btn btn-info" data-toggle="modal" data-target="#modal" onclick="add()" style="float:right;">Tambahkan Produk</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <button class="btn btn-warning" data-dismiss="modal" style="float:right;">Tutup</button>
    <button class="btn btn-info" type="submit" style="float:right;">Tambahkan</button></form>
  </div>
</div>
</div>
</div>
