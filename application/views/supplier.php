  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-12">
          <div class="col">
            <h1 class="m-0 text-dark text-center">Supplier</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <table class="table w-100 table-sm table-striped" id="supplier">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Nama</th>
      ...
      <div class="card-footer">
            <button class="btn btn-info" data-toggle="modal" data-target="#modal" onclick="add()" style="float:right;">Tambahkan Data Supplier</button>
        </div>
    </section>
    <!-- /.content -->
  </div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        <label>Barang</label>
        <textarea name="keterangan" class="form-control" placeholder="Informasi yang di-supply" required></textarea>
      </div>
