  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <center><h1 class="m-0 text-dark">Pembayaran</h1></center>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="container-fluid">
      <div class="card">
          ...
          <div class="col-sm-6">
            <div class="form-group ">
              ...
              <div class="form-inline">
                ...
                <span class="ml-10 text-info" id="nama_produk"></span>
              </div>
            ...
            <div class="form-group">
              <button id="tambah" class="btn btn-info" onclick="checkStok()" disabled>Tambah</button>
              <button id="bayar" class="btn btn-info" data-toggle="modal" data-target="#modal" disabled>Bayar</button>
            </div>
          </div>
        <span class="border border-dark">
          <div class="col-sm-12 d-flex justify-content-end text-right nota">
            <div>
              ...
              <b class="mr-6 text-bottom">Nota : </b> <span id="nota"></span> <br> <br>
              <b>Total</b> 
              </div>
              <span id="total" style="font-size: 80px; line-height: 1" class="text-info">-</span>
            </div>
          </div>
  </span>
        </div>
        ...
        <div class="card-body">
          <table class="table w-100 table-striped table-sm" id="transaksi">
            <thead>
              <tr>
                <th>Kode Produk</th>
                <th>Nama Produk</th>
...
<div class="modal-content">
  <div class="modal-header">
    <center><h5 class="modal-title">Pembayaran</h5></center>
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        ...
        <select name="Name" id="pelanggan" class="form-control select2"></select>
      </div>
      <div class="form-group">
        <label>Jumlah Uang</label>
        <input placeholder="Rp." type="number" class="form-control" name="jumlah_uang" onkeyup="kembalian()" required>
      </div>
      <div class="form-group">
        <label>Diskon</label>
      ...
      <div class="form-group">
        <label><b>Total Bayar:</b> <span class="total_bayar"></span></label>
      </div>
      <div class="form-group">
        <label><b>Kembalian:</b> <span class="kembalian"></span></label>
      </div>
...
<script>
  ...
  var pelangganSearchUrl = '<?php echo site_url('membership/search') ?>';
